    ...
    return new ImageResponse(
      (
        ...
        >
          ...
          <div style={{ display: 'flex' }}>You need to fund it with Ether</div>
          <div style={{ display: 'flex' }}>Source code: https://github.com/vadim91200/smart-account-frame-template</div>
        </div>
      ),
      {
        width: 1200,
